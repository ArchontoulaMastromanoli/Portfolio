...
const quizData = [
    ...
    {
        question: "Which is Mars' II Satellite?",
        a: "Deimos",
        b: "Phobos",
        c: "Carme",
        d: "Metis",
    ...
    {
        question: "How many Satellites does Uranus have?",
        a: "7",
        b: "15",
        c: "16",
        d: "17",
    ...
    {
        question: "How many Satellites does Pluto have?",
        a: "3",
        b: "4",
        c: "1",
        d: "8",
    ...
    if(answer) {
        ...
        if(currentQuiz < quizData.length){
            ...
            quiz.innerHTML = `
                ...
                <button class="satellites-button" type="button" onclick="location.href='../html_files/satellites.html'">Satellites</button>
